...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    // Phase 2 Delivery, Orders & Financials
    deliveryMethod: 'Delivery Method',
    standardDelivery: 'Standard Delivery',
    expressDelivery: 'Express Priority',
    farmerDirectDelivery: 'Farmer Direct Local',
    selfPickup: 'Self Farm Pickup (Free)',
    acceptOrder: 'Accept Order',
    rejectOrder: 'Reject Order',
    cancelOrder: 'Cancel Order',
    trackDelivery: 'Live Tracking',
    confirmDelivery: 'Confirm Delivery & Release Escrow',
    rateProduce: 'Rate & Review Produce',
    qualityScore: 'Product Quality',
    freshnessScore: 'Freshness',
    accuracyScore: 'Weight & Accuracy',
    communicationScore: 'Farmer Communication',
    writeReview: 'Write your review...',
    inputCosts: 'Production & Input Costs',
    addCost: 'Record New Cost',
    netProfit: 'Net Farm Profit',
    profitMargin: 'Profit Margin',
    wishlist: 'Saved Produce',
    mandiComparison: 'vs Mandi Market Rate',
    cheaperThanMandi: 'Cheaper than Mandi',
  },
  ...
  ta: {
    ...
    standardDelivery: 'வழக்கமான டெலிவரி',
    expressDelivery: 'விரைவு முன்னுரிமை',
    farmerDirectDelivery: 'விவசாயி நேரடி டெலிவரி',
    selfPickup: 'தோட்டத்தில் நேரடி கொள்முதல் (இலவசம்)',
    acceptOrder: 'ஆர்டரை ஏற்றுக்கொள்',
    rejectOrder: 'ஆர்டரை நிராகரி',
    cancelOrder: 'ஆர்டரை ரத்து செய்',
    trackDelivery: 'நேரடி கண்காணிப்பு',
    confirmDelivery: 'பொருள் பெற்றது உறுதி & பணம் விடுவி',
    rateProduce: 'பொருள் தரம் மற்றும் மதிப்புரை',
    qualityScore: 'பொருளின் தரம்',
    freshnessScore: 'புத்துணர்ச்சி',
    accuracyScore: 'எடை மற்றும் துல்லியம்',
    communicationScore: 'விவசாயி தொடர்பு',
    writeReview: 'உங்கள் கருத்தை பதிவிடுக...',
    inputCosts: 'விளைச்சல் & உள்ளீட்டு செலவுகள்',
    addCost: 'புதிய செலவை சேர்',
    netProfit: 'நிகர லாபம்',
    profitMargin: 'லாப சதவீதம்',
    wishlist: 'விருப்பப் பட்டியல்',
    mandiComparison: 'மண்டி சந்தை விலையுடன் ஒப்பீடு',
    cheaperThanMandi: 'மண்டியை விட விலை குறைவு',
  },
};
