...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    feed: 'Social Feed',
    chat: 'Messages',
    createPost: 'Create Harvest Post',
    ...
    noPostsDesc: 'Be the first farmer to share a fresh harvest update!',
  ...
  ta: {
    ...
    // Navigation & Tabs
    home: 'முகப்பு',
    homeFeed: 'முகப்பு ஊட்டப்பதிவு',
    feed: 'சமூகப் பதிவுகள்',
    chat: 'செய்திகள்',
    createPost: 'விளைபொருள் பதிவு செய்க',
    publishPost: 'பதிவை வெளியிடு',
    likes: 'விருப்பங்கள்',
    comments: 'கருத்துக்கள்',
    reply: 'பதில்',
    writeComment: 'உங்கள் கருத்தை எழுதுங்கள்...',
    writeReply: 'பதில் எழுதுங்கள்...',
    sendMessage: 'செய்தி அனுப்புக...',
    noPostsYet: 'இன்னும் எந்த பதிவும் இல்லை',
    noPostsDesc: 'இன்றைய புதிய அறுவடை விவரங்களை முதன்முதலில் பகிருங்கள்!',
    switchMode: 'பயன்முறையை மாற்று',
    farmerMode: 'விவசாயி பயன்முறை',
    consumerMode: 'நுகர்வோர் பயன்முறை',
